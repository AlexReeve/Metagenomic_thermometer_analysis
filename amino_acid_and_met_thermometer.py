...
def amino_acid_count(genome):
    ...
    IVYWREL_fraction = (IVYRWEL_count/sequence_count)
    predicted_ogt = (937 * IVYWREL_fraction) - 335
    predicted_ogt_2dp = "{:.2f}".format(predicted_ogt)
    
    
    return predicted_ogt_2dp, I_fraction, V_fraction, Y_fraction, W_fraction, R_fraction, E_fraction, L_fraction, A_fraction, N_fraction, D_fraction, C_fraction, Q_fraction, G_fraction, H_fraction, K_fraction, M_fraction, F_fraction, P_fraction, S_fraction, T_fraction, B_fraction, Z_fraction, O_fraction, U_fraction, X_fraction, J_fraction, other_fraction
...
def create_predicted_vs_actual(data):
    ...
    for index, row in data.iterrows():
        ...
        count = count +1
        # visualise it
        organism_name = output.loc[index, "organism_name"]
        print("====================================")
        ...
        if actual_genome_address == "No File":
            ...
            J_fraction= "N/A"
            other_fraction= "N/A"
            print(f" genome count is {count}")
            print("-----COULD NOT DOWNLOAD GENOME-----")
            print(f"not downloaded {organism_name}")
            ...
            predicted_ogt, I_fraction, V_fraction, Y_fraction, W_fraction, R_fraction, E_fraction, L_fraction, A_fraction, N_fraction, D_fraction, C_fraction, Q_fraction, G_fraction, H_fraction, K_fraction, M_fraction, F_fraction, P_fraction, S_fraction, T_fraction, B_fraction, Z_fraction, O_fraction, U_fraction, X_fraction, J_fraction, other_fraction = amino_acid_count(unzipped_genome)
            ...
            print(f"genome count is {count}")
            print(f"genome is {organism_name}")
...
output_name = 'amino_acid_and_predicted_IVYWREL_OGT.csv'
